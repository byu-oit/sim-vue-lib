<template>
  ...
  <div class="mx-calendar"
    ...
    <div class="mx-calendar-header">
      ...
      <span v-if="bYearHover">Move back a year</span>
      <a
        v-show="panel === 'DATE'"
        class="mx-icon-last-month"
        @mouseover="bMonthHover = true"
        @mouseleave="bMonthHover = false"
        @click="handleIconMonth(-1)">&#8249;</a>
      <span v-if="bMonthHover">Move back a month</span>
      <a
        v-show="panel !== 'TIME'"
        class="mx-icon-next-year"
        @mouseover="aYearHover = true"
        @mouseleave="aYearHover = false"
        @click="handleIconYear(1)">&#187;</a>
      <span v-if="aYearHover">Move ahead a year</span>
      <a
        v-show="panel === 'DATE'"
        class="mx-icon-next-month"
        @mouseover="aMonthHover = true"
        @mouseleave="aMonthHover = false"
        @click="handleIconMonth(1)">&#8250;</a>
      <span v-if="aMonthHover">Move ahead a month</span>
      <a
        v-show="panel === 'DATE'"
